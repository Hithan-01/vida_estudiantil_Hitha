...
$temp = new Template('Editar Mi Ministerio');
$db = new Conexion();
...
if (!$temp->es_director_ministerio()) {
    echo "Acceso denegado. Solo para directores de ministerio.";
    exit();
}
...
if (!$ministerio) {
    echo "No tienes un ministerio asignado.";
    exit();
}
...
$galeria_existente = array_filter(array_map(function($img) {
        ...
        <main>
            <div class="container">
                ...
                <div class="page-title-container">
                    <div class="row">
                        <div class="col-12 col-md-8">
                            <h1 class="mb-0 pb-0 display-4">Editar Ministerio</h1>
                            <nav class="breadcrumb-container d-inline-block">
                                <ul class="breadcrumb pt-0">
                                    <li class="breadcrumb-item"><a href="<?php echo $temp->siteURL ?>">Inicio</a></li>
                                    <li class="breadcrumb-item"><a href="/cpanel/pages/mi-ministerio/">Mi Ministerio</a></li>
                                    <li class="breadcrumb-item active">Editar</li>
                                </ul>
                            </nav>
                        </div>
                        <div class="col-12 col-md-4 d-flex align-items-start justify-content-end">
                            <a href="/cpanel/pages/mi-ministerio/" class="btn btn-outline-secondary">
                                <i data-acorn-icon="chevron-left"></i> Volver a Mi Ministerio
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <form id="formEditarMinisterio" enctype="multipart/form-data">
                    <input type="hidden" name="ministerio_id" value="<?php echo $ministerio['ID']; ?>">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nombre" name="nombre"
                                                   value="<?php echo htmlspecialchars($ministerio['NOMBRE']); ?>" required>
                                            <small class="text-muted">Este campo solo puede ser editado por administradores</small>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">Logo del Ministerio</label>
                                            <div>
                                                ...
                                                <small class="text-muted d-block mt-2">
                                                    ...
                                                    Las imágenes solo pueden ser editadas por administradores desde el panel de Ministerios
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="descripcion" name="descripcion" rows="4" required><?php echo htmlspecialchars($ministerio['DESCRIPCION']); ?></textarea>
                                        <small class="text-muted">Describe brevemente el propósito y actividades del ministerio</small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">¿Cuál es el objetivo principal del ministerio?</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="horario" name="horario" 
                                                   value="<?php echo htmlspecialchars($ministerio['HORARIO'] ?? ''); ?>"
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select class="form-select" id="dia_reunion" name="dia_reunion">
                                                ...
                                                foreach($dias as $dia) {
                                                    $selected = ($ministerio['DIA_REUNION'] == $dia) ? 'selected' : '';
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="lugar" name="lugar" 
                                                   value="<?php echo htmlspecialchars($ministerio['LUGAR'] ?? ''); ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="cupo_maximo" name="cupo_maximo" 
                                                   min="1" value="<?php echo $ministerio['CUPO_MAXIMO'] ?? ''; ?>"
                                                   placeholder="Dejar vacío para cupo ilimitado">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="telefono" class="form-label">Teléfono de Contacto</label>
                                            <input type="tel" class="form-control" id="telefono" name="telefono" 
                                                   value="<?php echo htmlspecialchars($ministerio['TELEFONO'] ?? ''); ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea class="form-control" id="requisitos" name="requisitos" rows="3"
                                                      placeholder="¿Qué requisitos necesita un estudiante para unirse?"><?php echo htmlspecialchars($ministerio['REQUISITOS'] ?? ''); ?></textarea>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="beneficios" class="form-label">Beneficios</label>
                                            <textarea class="form-control" id="beneficios" name="beneficios" rows="3"
                                                      placeholder="¿Qué beneficios obtienen los miembros del ministerio?"><?php echo htmlspecialchars($ministerio['BENEFICIOS'] ?? ''); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h5 class="card-title">Galería de Imágenes del Ministerio</h5>
                                </div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted d-block mb-3">Agrega fotos de actividades, eventos o reuniones del ministerio (JPG, PNG, GIF - Máx. 5MB)</small>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h5 class="card-title">Estado del Ministerio</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="estado" name="estado">
                                                <option value="BORRADOR" <?php echo ($ministerio['ESTADO'] == 'BORRADOR') ? 'selected' : ''; ?>>
                                                    En configuración (Borrador)
                                                </option>
                                                <option value="COMPLETO" <?php echo ($ministerio['ESTADO'] == 'COMPLETO') ? 'selected' : ''; ?>>
                                                    Listo para publicar (Completo)
                                                </option>
                                                <?php if($ministerio['ESTADO'] == 'PUBLICADO'): ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="alert alert-info mb-0">
                                                <small>
                                                    <strong>Borrador:</strong> Solo tú puedes ver el ministerio<br>
                                                    <strong>Completo:</strong> Listo para que administradores lo publiquen<br>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <a href="/cpanel/pages/mi-ministerio/" class="btn btn-secondary">
    ...
    <script>
        ...
        document.getElementById('formEditarMinisterio').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                const response = await fetch(siteURL + 'assets/API/mi-ministerio/actualizar', {
                    method: 'POST',
                    body: formData
                });
